...
public class FieldOrientedControllerTest {
    ...
    public void ControllerTest() {
        ...
        DifferentialDriveWheelSpeeds wheelSpeeds = controller1.calculate(new Vector2d(0.0, 1.0), new Rotation2d(0));
        ...
        wheelSpeeds = controller1.calculate(new Vector2d(0.0, 5.0), new Rotation2d(0));
        ...
        wheelSpeeds = controller1.calculate(new Vector2d(1.5, 2.5), new Rotation2d(0));
        ...
        wheelSpeeds = controller1.calculate(new Vector2d(6.28318531, 7.8), new Rotation2d(0));
        ...
        wheelSpeeds = controller2.calculate(new Vector2d(2.5, 5.0), new Rotation2d(0));
        ...
        DifferentialDriveWheelSpeeds wheelSpeeds2 = controller3.calculate(new Vector2d(2.5, 5.0), new Rotation2d(0));
